...
// Vs 旋转电压矢量 最大输出 
  ...
  /* uw_temp min value 0, max value 32767*32767 */
	//超出最大极限 Vs最大输出是32768的平方  Vd Vq的最大值分别为32768 32768  Vd2+Vq2 = 2*32768*32768
	//如果超出最大值就要按照比例将 Vd和Vq缩小到合适的位置 使平方和小于32768的平方
  if ( uw_temp > ( uint32_t )( pHandle->MaxModule ) * pHandle->MaxModule )
  {

    uw_temp /= ( uint32_t )( 16777216 );//将索引 从0-127 32768*32768/16777216
