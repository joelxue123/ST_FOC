...
{
  {
    .pFctGetPhaseCurrents              = &R3_2_GetPhaseCurrents,//获取两项相电流
    .pFctSwitchOffPwm                  = &R3_2_SwitchOffPWM,//pwm失能
    .pFctSwitchOnPwm                   = &R3_2_SwitchOnPWM,//pwm使能
    .pFctCurrReadingCalib              = &R3_2_CurrentReadingCalibration,//电流校准
    .pFctTurnOnLowSides                = &R3_2_TurnOnLowSides,//打开三路下管
    .pFctSetADCSampPointSectX          = &R3_2_SetADCSampPointSectX,//在扇区内设置采样点
    .pFctIsOverCurrentOccurred         = &R3_2_IsOverCurrentOccurred,//过流发生置标志位
    .pFctOCPSetReferenceVoltage        = MC_NULL,
    .pFctRLDetectionModeEnable         = &R3_2_RLDetectionModeEnable,//计算电阻电感开启
    .pFctRLDetectionModeDisable        = &R3_2_RLDetectionModeDisable,//关闭
    .pFctRLDetectionModeSetDuty        = &R3_2_RLDetectionModeSetDuty,//设置pwm占空比
...
CircleLimitation_Handle_t CircleLimitationM1 =
{
  ...
  .Circle_limit_table = MMITABLE,//调制数组初始化
  .Start_index        = START_INDEX,//索引初始化 57
};
